...
export default function AboutPreview() {
  ...
  return (
    <section className="w-full bg-transparent py-8 sm:py-20 lg:py-30">
      <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-10 px-4 sm:px-6 md:grid-cols-2 lg:gap-10 min-[1177px]:gap-8 min-[1280px]:gap-12 lg:px-8">
        ...
        <div className="w-full">
          ...
          <button className="mt-6 rounded-lg bg-text-primary px-6 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-90 font-banner">
            Know More About Us
          </button>
